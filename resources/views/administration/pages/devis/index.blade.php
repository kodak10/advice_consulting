...
<div class="container-fluid">
    ...
    <div class="widget-content searchable-container list">
      ...
      @if (Auth::user()->hasRole('Comptable'))
          <!-- Modals pour la section Comptable -->
        ...
        @foreach($mes_devis as $devi)
            <div class="modal fade" id="histoRefusModal{{ $devi->id }}" tabindex="-1" aria-labelledby="histoRefusModalLabel{{ $devi->id }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="histoRefusModalLabel{{ $devi->id }}">Message de Refus</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            {{ $devi->message ?? 'Aucun message fourni.' }}
        ...
        @endforeach
            ...
            <div class="card card-body">
                ...
                <div class="table-responsive">
                    <table id="comptable_proformas" class="table table-striped table-bordered text-nowrap align-middle">
                        <thead>
                            <tr>
                                <th>Date</th>
                                <th>N° Proforma</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ $devi->status ?? 'Non renseigné' }}
                                    @if($devi->status === 'Réfusé')
                                        <i class="ti ti-eye" data-bs-toggle="modal" data-bs-target="#histoRefusModal{{ $devi->id }}"></i>
                                    @endif
                                </td>
                                <td>
                                    <div class="action-btn text-center">
      ...
      @if (Auth::user()->hasRole('DG'))
        <div class="card card-body">
          ...
          <div class="table-responsive">
            ...
            <table id="zero_config5" class="table table-striped table-bordered text-nowrap align-middle">
              <thead>
                <tr>
                    <th>Date</th>
                    <th>N° Proforma</th>
