...
return [
    ...
    | utilisés par la classe de validation. Certaines de ces règles possèdent plusieurs
    | versions (par exemple, pour les règles de taille). N'hésitez pas à modifier ces
    ...
    */
    ...
    'decimal'              => 'Le champ :attribute doit avoir :decimal chiffre(s) après la virgule.',
    ...
    | certains attributs en utilisant la convention "attribute.rule" pour nommer
    | les lignes. Cela vous permet d'avoir rapidement une ligne de langue spécifique
    ...
    */
    ...
    | des attributs par quelque chose de plus lisible, par exemple "Adresse e-mail" au lieu de "email".
    | Cela permet de rendre nos messages plus expressifs.
    |
    */
